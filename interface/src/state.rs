...
use {
    ...
    trezoa_program_pack::{IsInitialized, Pack, Sealed},
...
impl Account {
    ...
    pub fn is_owned_by_system_program_or_incinerator(&self) -> bool {
        trezoa_sdk_ids::system_program::check_id(&self.owner)
            || trezoa_sdk_ids::incinerator::check_id(&self.owner)
    }
}
...
const TPL_TOKEN_ACCOUNT_MINT_OFFSET: usize = 0;
const TPL_TOKEN_ACCOUNT_OWNER_OFFSET: usize = 32;
