use {
    trezoa_account::Account as TrezoaAccount,
    trezoa_program_pack::Pack,
    trezoa_pubkey::Pubkey,
    trezoa_rent::Rent,
    tpl_token_interface::state::{Account, AccountState, Mint},
};
...
pub fn setup_token_account(mint: &Pubkey, owner: &Pubkey, amount: u64) -> TrezoaAccount {
    let data = {
