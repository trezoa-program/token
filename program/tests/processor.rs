...
use {
    ...
    serial_test::serial,
    trezoa_account::{create_account_for_test, Account as TrezoaAccount, ReadableAccount},
    trezoa_account_info::{AccountInfo, IntoAccountInfo},
...
fn do_process_instruction(
    ...
    mut accounts: Vec<&mut TrezoaAccount>,
    checks: &[Check],
) -> ProgramResult {
    // Prepare accounts for mollusk.
    let instruction_accounts: Vec<(Pubkey, TrezoaAccount)> = instruction
        .accounts
        .iter()
        .zip(&accounts)
...
fn test_initialize_mint() {
    let program_id = tpl_token_interface::id();
    let owner_key = Pubkey::new_unique();
    let mint_key = Pubkey::new_unique();
    let mut mint_account = TrezoaAccount::new(42, Mint::get_packed_len(), &program_id);
    let mint2_key = Pubkey::new_unique();
    let mut mint2_account =
        TrezoaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
...
fn test_initialize_mint_account() {
    ...
    let mut account_account = TrezoaAccount::new(42, Account::get_packed_len(), &program_id);
    let owner_key = Pubkey::new_unique();
    let mut owner_account = TrezoaAccount::default();
    let mint_key = Pubkey::new_unique();
...
fn test_transfer_dups() {
    ...
    let mut account1_account = TrezoaAccount::new(
    ...
    let mut account2_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    ...
    let mut account3_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    ...
    let mut account4_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    ...
    let mut multisig_account = TrezoaAccount::new(
...
fn test_transfer() {
    let program_id = tpl_token_interface::id();
    let account_key = Pubkey::new_unique();
    let mut account_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    ...
    let mut delegate_account = TrezoaAccount::default();
    let mismatch_key = Pubkey::new_unique();
    let mut mismatch_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    ...
    let mut owner2_account = TrezoaAccount::default();
    let mint_key = Pubkey::new_unique();
    let mut mint_account =
        TrezoaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
    let mint2_key = Pubkey::new_unique();
...
fn test_set_authority() {
    ...
    let mut owner3_account = TrezoaAccount::default();
    let mint_key = Pubkey::new_unique();
    let mut mint_account =
        TrezoaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
    let mint2_key = Pubkey::new_unique();
...
fn test_mint_to() {
    ...
    let mut uninitialized_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
...
fn test_burn_and_close_system_and_incinerator_tokens() {
    ...
    let mut incinerator_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    let system_account_key = Pubkey::new_unique();
    let mut system_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    ...
    let mut recipient_account = TrezoaAccount::default();
    let mut mock_incinerator_account = TrezoaAccount::default();
    let mint_key = Pubkey::new_unique();
    let mut mint_account =
        TrezoaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
...
fn test_multisig() {
    ...
    let mut mint_account =
        TrezoaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
    let account_key = Pubkey::new_unique();
    let mut account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    ...
    let mut owner_account = TrezoaAccount::default();
    let multisig_key = Pubkey::new_unique();
    let mut multisig_account = TrezoaAccount::new(42, Multisig::get_packed_len(), &program_id);
    let multisig_delegate_key = Pubkey::new_unique();
    let mut multisig_delegate_account = TrezoaAccount::new(
        multisig_minimum_balance(),
        Multisig::get_packed_len(),
        &program_id,
    );
    ...
    let mut signer_accounts = vec![TrezoaAccount::new(0, 0, &program_id); MAX_SIGNERS];
    let mut rent_sysvar = rent_sysvar();
...
fn test_owner_close_account_dups() {
    ...
    let mut to_close_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
    ...
    let mut destination_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
...
fn test_close_account() {
    ...
    do_process_instruction(
        initialize_account(
            &program_id,
            &account2_key,
            &tpl_token_interface::native_mint::id(),
            &owner_key,
        )
        .unwrap(),
        vec![
    ...
    let owner2_key = Pubkey::new_unique();
    let mut owner2_account = TrezoaAccount::new(
        account_minimum_balance(),
        Account::get_packed_len(),
        &program_id,
    );
...
fn test_native_token() {
    ...
    let account3_key = Pubkey::new_unique();
    let mut account3_account = TrezoaAccount::new(account_minimum_balance(), 0, &program_id);
    let owner_key = Pubkey::new_unique();
    let mut owner_account = TrezoaAccount::default();
    let owner2_key = Pubkey::new_unique();
    let mut owner2_account = TrezoaAccount::default();
...
fn test_overflow() {
    ...
    let mut mint_owner_account = TrezoaAccount::default();
    let mint_key = Pubkey::new_unique();
    let mut mint_account =
        TrezoaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
    let mut rent_sysvar = rent_sysvar();
...
fn test_freeze_account() {
    ...
    let mut account_owner_account = TrezoaAccount::default();
    let owner_key = Pubkey::new_unique();
    let mut owner_account = TrezoaAccount::default();
    let owner2_key = Pubkey::new_unique();
    let mut owner2_account = TrezoaAccount::default();
...
fn test_sync_native() {
    ...
    let lamports = 40;
    let mut native_account = TrezoaAccount::new(
        account_minimum_balance() + lamports,
        Account::get_packed_len(),
        &program_id,
    );
    let non_native_account_key = Pubkey::new_unique();
    let mut non_native_account = TrezoaAccount::new(
