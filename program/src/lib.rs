...
pub mod trezoa_program {
    #![allow(missing_docs)]
    pub mod entrypoint {
        pub use trezoa_program_error::ProgramResult;
    }
    pub mod instruction {
        pub use trezoa_instruction::{AccountMeta, Instruction};
    }
    pub mod program_error {
        pub use trezoa_program_error::ProgramError;
    }
    pub mod program_option {
        pub use trezoa_program_option::COption;
    }
    pub mod program_pack {
        pub use trezoa_program_pack::{IsInitialized, Pack, Sealed};
    }
    pub mod pubkey {
        pub use trezoa_pubkey::{Pubkey, PUBKEY_BYTES};
    }
}
use trezoa_program_error::ProgramError;
// Re-export tpl_token_interface items
pub use tpl_token_interface::{check_id, check_program_account, id, ID};
