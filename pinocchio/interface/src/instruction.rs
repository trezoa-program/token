...
pub enum TokenInstruction {
    ...
    /// will be equal to the amount of TRZ in the account. If this account is
    ...
    /// amounts of TRZ and Tokens will be transferred to the destination
    /// account.
    ///
    /// Accounts expected by this instruction:
    ///
    ...
    /// Given a wrapped / native token account (a token account containing TRZ)
    /// updates its amount field based on the account's underlying `lamports`.
    /// This is useful if a non-wrapped TRZ account uses
    ...
    /// This instruction is to be used to rescue TRZ sent to any `TokenProgram`
    ...
    /// Transfer lamports from a native TRZ account to a destination account.
    ///
    /// This is useful to unwrap lamports from a wrapped TRZ account.
    ///
    /// Accounts expected by this instruction:
    ///
    ///   * Single owner/delegate
    ...
    // token/js/src/instructions/types.ts to maintain @trezoa/tpl-token compatibility
}
