...
async fn amount_to_ui_amount() {
    ...
    let amount_to_ui_amount_ix = tpl_token_interface::instruction::amount_to_ui_amount(
...
fn amount_to_ui_amount_with_maximum_decimals() {
    ...
    let instruction =
        tpl_token_interface::instruction::amount_to_ui_amount(&tpl_token_interface::ID, &mint, 20)
            .unwrap();
...
fn amount_to_ui_amount_with_u64_max() {
    ...
    let instruction = tpl_token_interface::instruction::amount_to_ui_amount(
        &tpl_token_interface::ID,
        &mint,
        u64::MAX,
    )
