...
use {
    ...
    tpl_token_interface::state::Multisig,
};
...
async fn initialize_multisig2() {
    ...
    let initialize_ix = tpl_token_interface::instruction::initialize_multisig2(
    ...
    let multisig = tpl_token_interface::state::Multisig::unpack(&account.data).unwrap();
