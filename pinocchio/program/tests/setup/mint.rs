use {
    ...
    trezoa_program_test::{BanksClientError, ProgramTestContext},
...
pub async fn initialize_with_decimals(
    ...
    let mut initialize_ix = tpl_token_interface::instruction::initialize_mint(
...
pub async fn mint(
    ...
    let mut mint_ix = tpl_token_interface::instruction::mint_to(
        &tpl_token_interface::ID,
        mint,
        account,
        &mint_authority.pubkey(),
