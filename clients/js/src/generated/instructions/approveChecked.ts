...
import {
    ...
    getU8Decoder,
    getU8Encoder,
    TREZOA_ERROR__PROGRAM_CLIENTS__INSUFFICIENT_ACCOUNT_METAS,
    TrezoaError,
    transformEncoder,
    type AccountMeta,
...
import { getAccountMetaFactory, type ResolvedInstructionAccount } from '@trezoa/kit/program-client-core';
...
export function parseApproveCheckedInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (instruction.accounts.length < 4) {
        throw new TrezoaError(TREZOA_ERROR__PROGRAM_CLIENTS__INSUFFICIENT_ACCOUNT_METAS, {
