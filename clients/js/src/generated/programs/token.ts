...
import {
    ...
    containsBytes,
    getU8Encoder,
    TREZOA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_ACCOUNT,
    TREZOA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_INSTRUCTION,
    TREZOA_ERROR__PROGRAM_CLIENTS__UNRECOGNIZED_INSTRUCTION_TYPE,
    TrezoaError,
    type Address,
    type ClientWithRpc,
...
} from '@trezoa/kit/program-client-core';
import {
    getMintCodec,
    getMultisigCodec,
    getTokenCodec,
...
export function identifyTokenAccount(account: { data: ReadonlyUint8Array } | ReadonlyUint8Array): TokenAccount {
    ...
    throw new TrezoaError(TREZOA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_ACCOUNT, {
        accountData: data,
        programName: 'token',
    });
}
...
export function identifyTokenInstruction(
    ...
    throw new TrezoaError(TREZOA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_INSTRUCTION, {
...
export function parseTokenInstruction<TProgram extends string>(
    ...
    switch (instructionType) {
        ...
        default:
            throw new TrezoaError(TREZOA_ERROR__PROGRAM_CLIENTS__UNRECOGNIZED_INSTRUCTION_TYPE, {
